...
namespace Fsd.Kamil.Cs.Ex2_3.ProductMagazine
{
    public class Menu : TextWriter
    {
        ...
        public void ProductsDecision()
        {
            ...
            {
                case '1': Console.WriteLine($"You have bought: Product 1 "); break;

                case '2': Console.WriteLine($"You have bought: Product 2 "); break;

                case '3': Console.WriteLine($"You have bought: Product 3 "); break;
        ...
        public void NewProduct()
        {
            ...
            Console.WriteLine("Please enter your product 'COUNT':");
